...
(function () {
    ...
    // entering links.
    var linkDialogText = "<p>اطلاعات لینک را به این صورت وارد کنید:</p><code>http://example.com/ \"optional title\"</code>";
    var imageDialogText = "<p>http://example.com/images/diagram.jpg \"optional title\"</p>";

    // The default text that appears in the dialog input box when entering
    // links.
    var imageDefaultText = "http://placehold.it/400x400";
    var linkDefaultText = "http://google.com";
